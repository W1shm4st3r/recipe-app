package git.w1shm4st3r.recipeapp.bootstrap;

import git.w1shm4st3r.recipeapp.domain.*;
import git.w1shm4st3r.recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> tableSpoonUomOprional = unitOfMeasureRepository.findByDescription("Tablespoon");

        if (!tableSpoonUomOprional.isPresent()) {
            throw new RuntimeException("Expected UOM not found!");
        }
        ...
        UnitOfMeasure tableSpoonUom = tableSpoonUomOprional.get();
